...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="../php/profile.php"><i class="fas fa-user"></i> Profile</a></li>
                <li><a href="../php/hel_desk.php"><i class="fas fa-phone-alt"></i> Help Desk</a></li>
                <li><a href="../php/services.php"><i class="fas fa-phone-alt"></i> Services</a></li>
            ...
            <div class="modal-content">
                ...
                <form action="../function/submit_appointment.php" method="POST">
                    ...
                    try {
                        ...
                        $stmt = $pdo->prepare("SELECT slot_time FROM time_slots ORDER BY slot_time");
                        $stmt->execute();
                    ...
                    <?php
                    try {
                        $stmt = $pdo->prepare("SELECT ServiceName FROM services ");
                        $stmt->execute();
                    ...
                    <select id="time" name="time" required>
                        ...
                        foreach ($time_slots as $slot) {
                            ...
                            echo "<option value=\"{$slot['slot_time']}\" data-id=\"{$slot['id']}\">{$formatted_time}</option>";
                        }
                        ?>
                    </select>
    ...
    $(document).ready(function() {
        $('#time').change(function() {
            ...
            var slotId = $("#time option:selected").data('id');

            if (selectedTime && slotId) {
                // Send AJAX request to update the status
                $.ajax({
                    url: 'update_time_slot_status.php',
                    type: 'POST',
                    data: {
                        slot_id: slotId,
                        status: 'booked' // Initially set it to booked
                    },
                    success: function(response) {
                        if (response === 'success') {
                            alert("Time slot has been successfully booked!");
                        } else {
                            alert("Error: Could not book the time slot.");
                        }
                    },
                    error: function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                headerToolbar: {
                    left: '',
                    center: 'title',
                    right: 'prev,next today,timeGridDay,dayGridMonth'
                },
                businessHours: {
